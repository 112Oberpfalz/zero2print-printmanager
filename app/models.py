...
class PrintJob(Base):
    ...
    filament_use_case = Column(String, nullable=True, default="standard")
    filament_temperature = Column(String, nullable=True, default="normal")
    filament_finish = Column(String, nullable=True, default="standard")
